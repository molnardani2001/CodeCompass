...
function (topic, Menu, MenuItem, PopupMenuItem, astHelper, model, urlHandler, viewHandler) {
    ...
    render : function (nodeInfo, fileInfo) {
      return new MenuItem({
        ...
        onClick : function () {
          ...
          astHelper.jumpToDef(nodeInfo.id, model.csharpservice);
  ...
  viewHandler.registerModule(getdefintion, {
    ...
    service : model.csharpservice
  });

  var infoTree = {
    id : 'csharp-text-infotree',
    render : function (nodeInfo, fileInfo) {
      return new MenuItem({
        label : 'Info Tree',
        onClick : function () {
  ...
  var diagrams = {
    ...
    render : function (nodeInfo, fileInfo) {
      ...
      var diagramTypes = model.csharpservice.getDiagramTypes(nodeInfo.id);
